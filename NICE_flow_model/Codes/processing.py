...
class Processor_cond():
    ...
    #Data cleaning
    def constraindata(self, Galaxies, copy_data=True, info=True, percentile1=98, percentile2=98, feh_min=-8, ofe_min=-1, N_min=0, r_max=27.7):
        """
        Does the data cleaning, based on the parameters given in the initialization.
        ...
        for galaxy in Galaxies:
            ...
            og_len = len(galaxy["stars"])

            #Apply constrains now
            galaxy = _custom_copy(galaxy, copy_data=copy_data)
            galaxy["stars"] = galaxy["stars"][is_valid]
            now_len = len(galaxy["stars"])
            gal_name = galaxy["galaxy"]["NIHAO_id"]
            stars_left[gal_name]=((og_len-now_len)/(og_len))*100
        ...
        return Galaxies_out, Galaxies_left, stars_left
    ...
    def sample_Conditional(self, model, Condition:typing.Union[pd.DataFrame, dict], split_size=300000, GPUs=None, reinsert_condition="all") -> pd.DataFrame:
        ...
        cond_names_in_right_order = ['lv1', 'lv2', 'lv3', 'lv4', 'lv5', 'lv6', 'lv7', 'lv8', 'lv9', 'lv10', 'lv11', 'lv12', 'lv13', 'lv14', 'lv15', 'lv16', 'M_stars', 'tau50', 'tau10', 'Z_av']
